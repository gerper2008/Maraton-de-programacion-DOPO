...
public class Wheel
{
    ...
    /**
     * Gira la rueda una posición hacia adelante. No tiene efecto si la
    ...
    /**
     * Gira la rueda un número arbitrario de pasos. Los pasos pueden ser
     * negativos para girar en sentido contrario. No tiene efecto si la
     * rueda está bloqueada o si está vacía.
     *
    ...
    /**
     * Bloquea la rueda para que spin() no la afecte.
     */
    public void lock()
    {
        locked = true;
    ...
    /**
     * Obtiene la posición actual de la rueda (base 1).
     *
